...
import { Mail, MessageCircle, Phone, HelpCircle, Settings as SettingsIcon, Shield, Database, Users } from "lucide-react";
      ...
      <Card className="border-blue-200 bg-blue-50/50">
        ...
        <CardContent>
          <p className="text-sm text-blue-700 mb-4">
            Need assistance with platform administration or have technical questions?
